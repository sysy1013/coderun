...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const viewanswer = await questionDB.getQeustionByQanswer(client,questionId);
    
    // 성공적으로 users를 가져왔다면, response를 보내줍니다.
    res.status(statusCode.OK).send(util.success(statusCode.OK, responseMessage.READ_ALL_USERS_SUCCESS, viewanswer));
